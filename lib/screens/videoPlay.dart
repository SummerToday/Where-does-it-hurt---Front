...
class _VideoPlayerScreenState extends State<VideoPlayerScreen> {
  ...
  void initState() {
    ...
    if (adress == '교정') {
      ...
      //내과
    } else if (adress == '위내시경 수술') {
      _controller = VideoPlayerController.network(
        'https://www.youtube.com/watch?v=N6UiNhSUt00',
      ); // x
    ...
    //신경외과
    else if (adress == '척추 내시경 수술') {
      _controller = VideoPlayerController.network(
        'https://www.youtube.com/watch?v=zjsvkXXSAxM',
      ); // x
